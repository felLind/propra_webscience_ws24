...
Das größte verwendete \emph{DeepSeek-R1} basierte Modell erreichte die höchste Genauigkeit mit 93\% mit dem Anfrage-Ansatz.
Mit einem aspektbasierten Anfrage-Ansatz wurden mit den \emph{DeepSeek-R1}-basierten Modellen Genauigkeiten bis zu 98\% erzielt.

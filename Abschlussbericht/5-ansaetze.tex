...
Weil diese Ansätze auf dem verwendeten Datensatz schlechtere Ergebnisse erzielten und darüber hinaus längere Laufzeiten benötigten, wurden sie verworfen.
...
In einem zweiten Ansatz haben wir die \textit{DeepSeek}-R1-Modelle mittels \textit{Ollama} \cite{ollama2025meta} ausgeführt und mittels Anfragen eine Klassifizierung der Tweets durch die Modelle durchgeführt.

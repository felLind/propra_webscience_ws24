...
Drei klassische Algorithmen – logistische Regression, Support Vector Machines (SVM) und Naive Bayes-Klassifikator – erreichten maximale Genauigkeiten von bis zu 86\,\%. 

...
\germanabstract{
    ...
    Dazu wurden verschiedene Vorverarbeitungsschritte und Vektorisierungsverfahren für klassishce Methoden angwendet und evaluiert.
    Für die Deep-Learning Ansätze wurden \textit{Finetuning} Ansätze für \textit{BERT}-basierte Modelle und \textit{DeepSeek}-R1 basierte Modelle verwendet.

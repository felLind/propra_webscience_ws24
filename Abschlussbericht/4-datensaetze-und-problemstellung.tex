...
Es wurden die separaten Trainings- und Testdatensätze des von Go et al. \cite{go2009twitter} erstellte \textit{Sentiment140} Datensatzes verwendet.
...
Die Tweets wurden mit Hilfe der Twitter-API gesammelt, indem nach Tweets gesucht wurde, die bestimmte Emoticons mit positiver oder negativer Bedeutung enthalten (siehe Tabelle 3 im Artikel zum Datensatz \cite[S. 4]{go2009twitter}).
...
Als Noisy Labels werden Labels bezeichnet, die nicht fehlerfrei sind und die Qualität der Datensätze beeinträchtigen können \cite{song2022learning}.
...
Die Tweets wurden über die Twitter-API durch Anfrage mit spezifischen Query-Ausdrücken ausgewählt und manuell mit Sentiment-Klassen versehen.
Die Query-Ausdrücke sind in Tabelle 4 des Artikels von Go et al. \cite[S. 5]{go2009twitter} aufgeführt und sind im Testdatensatz enthalten.

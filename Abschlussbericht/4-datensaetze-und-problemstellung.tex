...
Go et al. \cite{go2009twitter} weisen darauf hin, dass die Stimmungsklassen nicht fehlerfrei sind \cite[Abschn. 2.2]{go2009twitter} und es sich um \textit{Noisy Labels} handelt.
...
Weiterhin enthält der Datensatz keine Retweets und wenige Duplikate (weniger als $2\%$ der Daten).

\subsubsection{Testdatensatz}\label{subsec:testdata}

Von Go et al. \cite{go2009twitter} wurde zusätzlich ein Testdatensatz mit 498 Tweets erstellt, der 177 Tweets mit positiver Stimmung und 182 Tweets mit negativer Stimmung enthält.

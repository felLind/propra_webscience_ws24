...
Weiterhin wurden leere Tweets und Duplikate nach der Bereinigung entfernt.
...
Die Werte für die Lernrate lagen zwischen $10^{-4}$ und $10^{-6}$ und die Datensatzgröße zwischen 2.500 und 20.000.
Die Werte sind in Tabelle \ref{tab:dl-params} aufgeführt und orientieren sich an dem Vorgehen von Barbieri et al. \cite{barbieri2020tweeteval}.
...
Für alle Modelle steigt die Genauigkeit, wenn mehr als nur Unigramme berücksichtigt werden.

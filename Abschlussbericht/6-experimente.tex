...
Die Werte für die Lernrate lagen zwischen $1e^{-4}$ und $1e^{-6}$ und die Datensatzgröße zwischen 2500 und 20000. Die Werte sind in Tabelle \ref{tab:dl-params} aufgeführt und orientieren sich an dem Vorgehen von Barbieri et al. \cite{barbieri2020tweeteval}.

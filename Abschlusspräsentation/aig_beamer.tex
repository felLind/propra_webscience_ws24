...
\begin{frame}{Ergebnisse}
    \centering
    \includegraphics[width=0.79\textheight]{figures/klassische-ml-beste-genauigkeit-pro-modell-truncated-y-axis.png}
\end{frame}
...
\begin{frame}{Ergebnisse}
    \centering
     \includegraphics[scale=0.3]{figures/bert-based-genauigkeit-bert-basierte-modelle_-default-vs.-fine-tuned-truncated-y-axis.png}
\end{frame}
...
\begin{frame}{Ergebnisse}
    \centering
    \includegraphics[scale=0.3]{figures/deepseek-genauigkeit-deepseek-modelle_-einfluss-query-ausdruck-truncated-y-axis.png}
\end{frame}
...
\begin{frame}{Zusammenfassung}
    \centering
    \includegraphics[scale=0.3]{figures/alle-übersicht-genauigkeit-alle-modelle-truncated-y-axis.png}
\end{frame}
